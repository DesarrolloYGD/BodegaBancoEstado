...
namespace BancoEstadoBodega.Controllers
{
    ...
    public class SolicitudController : Controller
    {
        ...
        public ActionResult Editar([Bind(Include = "idSolicitud,descripcion,idTipoEncomienda,idTipoEmpaque,origen,idTipoDespacho,idTrasladoDespacho,destino,fechaSolicitud,fechaEntrega,codigoSeguimiento,idTipoPedido,idArea,usuarioMandante,usuarioReceptor,observacion,estado,correo")] SolicitudPedido sol)
        {
