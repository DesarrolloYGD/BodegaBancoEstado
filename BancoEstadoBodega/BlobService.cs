    ...
    public class BlobService
    {
        ...
        public void AddImgProducto(HttpPostedFileBase imagen, string id_imgProducto)
        {
            try
            {
                ...
                CloudBlobContainer contenedor = cliente.GetContainerReference("prueba-fotos");//especificaciòn del contenedor que almacena los blobs
        ...
        public byte[] GetImgProducto(string id_imgProducto)
        {
            ...
            CloudBlobContainer contenedor = cliente.GetContainerReference("prueba-fotos");
